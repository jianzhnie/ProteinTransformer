...
import torch.distributed.distributed_c10d as DDP
...
from deepfold.data.protein_dataset import ProteinSequenceDataset
# Network definition
from deepfold.models.bertprot import ProteinClassifier
...
def _get_train_data_loader(batch_size, training_dir):
    dataset = pd.read_csv(
        os.path.join(training_dir, 'deeploc_per_protein_train.csv'))
...
def _get_test_data_loader(batch_size, training_dir):
    dataset = pd.read_csv(
        os.path.join(training_dir, 'deeploc_per_protein_test.csv'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr',
                        ...
                        default=0.3e-5,
                        metavar='LR',
                        help='learning rate (default: 0.3e-5)')
