...
from transformers.models.big_bird.modeling_big_bird import (
    BigBirdClassificationHead, BigBirdModel, BigBirdPreTrainedModel)
from transformers.models.camembert.configuration_camembert import \
    CamembertConfig
...
from transformers.models.electra.modeling_electra import (
    ELECTRA_PRETRAINED_MODEL_ARCHIVE_LIST, ElectraConfig, ElectraModel,
    ElectraPreTrainedModel)
from transformers.models.longformer.modeling_longformer import (
    LongformerClassificationHead, LongformerPreTrainedModel)
from transformers.models.roberta.configuration_roberta import RobertaConfig
from transformers.models.roberta.modeling_roberta import (
    ROBERTA_PRETRAINED_MODEL_ARCHIVE_LIST, RobertaClassificationHead,
...
class SequenceClassifierOutput(ModelOutput):
    ...
    Args:
        ...
        preds (`torch.FloatTensor` of shape `(batch_size, config.num_labels)`):
            Classification (or regression if config.num_labels==1) labels.
...
class RobertaForMultiLabelSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config, pos_weight=None):
        super(RobertaForMultiLabelSequenceClassification,
...
class BertweetForMultiLabelSequenceClassification(
    ...
    BERTweet shares the Roberta architecture, so we can reuse the simpletransformers RobertaForMultiLabelSequenceClassification implementation
    """
...
class XLMForMultiLabelSequenceClassification(XLMPreTrainedModel):
    ...
    def forward(
        ...
        outputs = (logits, ) + transformer_outputs[
            1:]  # Keep new_mems and attention/hidden states if they are here
...
class FlaubertForMultiLabelSequenceClassification(FlaubertModel):
    ...
    def __init__(self, config, pos_weight=None):
        super(FlaubertForMultiLabelSequenceClassification,
              self).__init__(config)
        self.num_labels = config.num_labels
        self.pos_weight = pos_weight
...
class LongformerForMultiLabelSequenceClassification(LongformerPreTrainedModel):
    ...
    def __init__(self, config, pos_weight=None):
        super(LongformerForMultiLabelSequenceClassification,
              self).__init__(config)
        self.num_labels = config.num_labels
        self.pos_weight = pos_weight
...
class ElectraForMultiLabelSequenceClassification(ElectraPreTrainedModel):
    """ElectraForSequenceClassification model adapted for multi-label sequence
    classification."""
...
class ElectraForQuestionAnswering(ElectraPreTrainedModel):
    """Identical to BertForQuestionAnswering other than using an
    ElectraModel."""
...
class BigBirdForMultiLabelSequenceClassification(BigBirdPreTrainedModel):
    """Bert model adapted for multi-label sequence classification."""
    def __init__(self, config, pos_weight=None):
        super(BigBirdForMultiLabelSequenceClassification,
              self).__init__(config)
        self.num_labels = config.num_labels
        self.config = config
...
class DualEncoderModel(PreTrainedModel):
    def __init__(
        ...
        super().__init__(
            config=context_config)  # Initialize with context_config for now
