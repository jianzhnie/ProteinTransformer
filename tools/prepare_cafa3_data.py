...
@ck.command()
@ck.option(
    '--go-file', '-gf', default='go_cafa3.obo',
    help='Gene Ontology file in OBO Format')
@ck.option(
    '--train-sequences-file', '-trsf', default='CAFA3_training_data/uniprot_sprot_exp.fasta',
    help='CAFA training sequences fasta')
@ck.option(
    '--train-annotations-file', '-traf', default='CAFA3_training_data/uniprot_sprot_exp.txt',
    help='CAFA training annotations fasta')
@ck.option(
    '--test-sequences-file', '-tssf', default='CAFA3_targets/targets_all.fasta',
    help='CAFA training annotations fasta')
@ck.option(
    '--test-annotations-file', '-tsaf', default='benchmark20171115/groundtruth/leafonly_all.txt',
    help='CAFA training annotations fasta')
@ck.option(
    '--out-terms-file', '-otf', default='terms.pkl',
    help='Result file with a list of terms for prediction task')
@ck.option(
    '--train-data-file', '-trdf', default='train_data.pkl',
    help='Result file with a list of terms for prediction task')
@ck.option(
    '--test-data-file', '-tsdf', default='test_data.pkl',
    help='Result file with a list of terms for prediction task')
@ck.option(
    '--min-count', '-mc', default=1,
