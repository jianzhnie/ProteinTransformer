...
if __name__ == '__main__':
    ...
    with open('deepfold/__version__.py') as fh:
    ...
    setup(
        ...
        description='DeepFold for protein seqence function annotation.',
        ...
        keywords=['protein seqence', 'nlp', 'machine learning', ''],
        python_requires='>=3.7',
        url='https://github.com/jianzhnie/X-DeepGo',
    )
